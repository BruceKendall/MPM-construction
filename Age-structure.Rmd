...
lizard <- data.frame(x = 0:7, px = c(round(px, 3), NA), bx = c(NA, bx))
knitr::kable(
  lizard,
  caption = "Age-specific survival and birth rates for the lizard _Lacerta vivipara_ in the Netherlands [@Strijbosch1988]. ",
