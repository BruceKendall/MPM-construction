...
1. Make an $(l+1) \times (l+1)$ matrix with the matureation rates subtracted from one on the diagonal, and zeros everywhere else
...
## Example
To illustrate these calculations, we use data on the frog *Rana aurora* from Table 1 of @Biek2002. There are seven stages (eggs, embryos, larae, metamorphs, juveniles and adults), but the first four are completed in the course of the animal's first year, so for the model we focus only on eggs, juveniles, and adults.
